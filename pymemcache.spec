...
Version  : 3.3.0
Release  : 54
URL      : https://files.pythonhosted.org/packages/99/36/e3368e7eaff6e14a06e389253cafca49502ac3d5db6547c45072d3f44ca9/pymemcache-3.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/99/36/e3368e7eaff6e14a06e389253cafca49502ac3d5db6547c45072d3f44ca9/pymemcache-3.3.0.tar.gz
...
%prep
%setup -q -n pymemcache-3.3.0
cd %{_builddir}/pymemcache-3.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597938848
...
cp %{_builddir}/pymemcache-3.3.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pymemcache/2b8b815229aa8a61e483fb4ba0588b8b6c491890
